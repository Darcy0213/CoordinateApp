...
export const createLinearGradientThirdColor = (
  color: string,
  opacity: number,
  thirdColor: string,
  thirdOpacity: number
...
export const extractAndSortColors = (
  customPaletteColors: CustomPaletteProps
): { color: string; contrast: string; variant: string; id: string }[] => {
...
export function findIconOrColorById(icons: any, searchId: string) {
  return (
    icons &&
    searchId &&
    icons.find((item: any) => item.id.toLowerCase() === searchId.toLowerCase())
  );
}
export function findIconById(
  ...
  return (
    icons &&
    searchId &&
    icons.find((item) => item.id.toLowerCase() === searchId.toLowerCase())
  );
}
