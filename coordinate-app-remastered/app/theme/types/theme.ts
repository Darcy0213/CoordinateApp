...
export type Elevation = {
  ...
  4: string;
  5: string;
  "1_blur": { boxShadow: string; blurBackdropFilter: string };
};
...
export type CustomDimensionsProps = {
  ...
  modal: ModalWidth;
  drawer: WidthDimensions;
};
export type PageDimensions = {
  width: WidthDimensions;
  padding: PagePadding;
  spacing: SimpleDimensions;
};
export type FrameDimensions = {
  padding: BasicDimensions;
  spacing: BasicDimensions;
};
...
export type ElementTypes = {
  padding: AdvancedDimensions;
  spacing: AdvancedDimensions;
  height: BasicDimensions;
  width: BasicDimensions;
  switch: SwitchTypes;
  avatar: AvatarTypes;
  iconButton: IconButtonTypes;
  buttonTextIcon: ButtonTypes;
  iconText: IconTextTypes;
};

export type ButtonTypes = {
  padding: { horizontal: BasicDimensions; vertical: BasicDimensions };
};

export type IconButtonTypes = {
  padding: SimpleDimensions;
};
export type IconTextTypes = {
  gap: SimpleDimensions;
};
export type AvatarTypes = {
  height: SimpleDimensions;
  width: SimpleDimensions;
};
